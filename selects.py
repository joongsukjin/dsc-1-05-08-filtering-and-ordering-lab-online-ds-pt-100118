def select_all_female_dogs_name_and_breed():
    return "SELECT name, breed FROM dogs WHERE breed == F;"
...
def select_hungry_dogs_name_and_breed_ordered_by_youngest_to_oldest():
    return "SELECT name breed FROM dogs WHERE temperament == hungry ORDER BY age ASC"
...
def select_name_age_and_hungry_of_hungry_dogs_between_age_two_and_seven_in_alphabetical_order():
    return "SELECT name age hungry FROM dogs WHERE temperament == hungry AND  age BETWEEN 2 AND 7 ORDER BY name "
